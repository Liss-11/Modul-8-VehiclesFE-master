...
var cars = new Array();
var nuevo_coche = document.querySelector('#nuevo_coche');
/* contador coches */
var i = 0;
...
var pagina3 = document.querySelector("#pagina3");
var listado = document.querySelector("#listado");
/* ventana modal que muestra el coche nuevo_coche */
var modal_coche = document.querySelector('#modal-coche');
...
function addWheels() {
    var acumError = 0;
    var ruedas = new Array;
    var diametros = new Array;
    /* creación rueda 1 */
    var marca1 = document.querySelector('#marca_r1');
    var diametro1 = document.querySelector('#diametro_r1');
    var error_marca1 = document.querySelector("#error_marca1");
    var error_diametro1 = document.querySelector("#error_diametro1");
    ...
    var wheel1 = new Wheel(diametro1.value, marca1.value);
    /* newCar[i].addWheel(wheel1); */
    ruedas.push(wheel1);
    diametros.push(diametro1);
    /* creación rueda 2 */
    var marca2 = document.querySelector('#marca_r2');
    var diametro2 = document.querySelector('#diametro_r2');
    var error_marca2 = document.querySelector("#error_marca2");
    var error_diametro2 = document.querySelector("#error_diametro2");
    ...
    var wheel2 = new Wheel(diametro2.value, marca2.value);
    /* newCar[i].addWheel(wheel2); */
    ruedas.push(wheel2);
    diametros.push(diametro2);
    /* creación rueda 3 */
    var marca3 = document.querySelector('#marca_r3');
    var diametro3 = document.querySelector('#diametro_r3');
    var error_marca3 = document.querySelector("#error_marca3");
    var error_diametro3 = document.querySelector("#error_diametro3");
    ...
    var wheel3 = new Wheel(diametro3.value, marca3.value);
    /* newCar[i].addWheel(wheel3); */
    ruedas.push(wheel3);
    diametros.push(diametro3);
    /* creación rueda 4 */
    var marca4 = document.querySelector('#marca_r4');
    var diametro4 = document.querySelector('#diametro_r4');
    var error_marca4 = document.querySelector("#error_marca4");
    var error_diametro4 = document.querySelector("#error_diametro4");
    /*  validacion bootstrap rueda3 */
    if (marca4.value == "") {
    ...
    var wheel4 = new Wheel(diametro4.value, marca4.value);
    /* newCar[i].addWheel(wheel4); */
    ruedas.push(wheel4);
    diametros.push(diametro4);
    /* diametros con error */
    var x = new Array;
    diametros.forEach(function (element, index) {
    ...
    var ruedasMal = document.querySelector("#staticBackdropLabel");
    /* boton para cerrar la ventada modal */
    var corregirRueda = document.querySelector("#corregirRueda");
    if (acumError > 0) {
        ...
        ruedas.forEach(function (element) {
...
var guardar_coches = document.querySelector('#guardar-coche');
...
var listado_coches = document.querySelector('#lista-coches');
...
var borrar_coche = document.querySelector("#borrar_coche");
...
function limpiar(elemento) {
    var limpiar = document.getElementById(elemento);
    limpiar.value = "";
}
